...
export class NumberInfoComponent implements OnChanges {
  ...
  set title(value: string | TemplateRef<any>) {
    if (value instanceof TemplateRef) this._titleTpl = value
  ...
  set subTitle(value: string | TemplateRef<any>) {
    if (value instanceof TemplateRef) this._subTitleTpl = value
  ...
  set total(value: string | TemplateRef<any>) {
    if (value instanceof TemplateRef) this._totalTpl = value
  ...
  set subTotal(value: string | TemplateRef<any>) {
    if (value instanceof TemplateRef) this._subTotalTpl = value
