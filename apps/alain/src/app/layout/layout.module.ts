...
const COMPONENTS = [LayoutComponent, LayoutFullScreenComponent, HeaderComponent, SidebarComponent]
...
const PRO = [ProUserLayoutComponent]

@NgModule({
  imports: [SharedModule],
  providers: [],
  declarations: [SidebarNavComponent, ...COMPONENTS, ...HEADERCOMPONENTS, ...PRO],
  exports: [...COMPONENTS, ...PRO],
})
