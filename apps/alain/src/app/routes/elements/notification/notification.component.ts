...
export class NotificationComponent {
  constructor(private msg: NzMessageService, private ntf: NzNotificationService) {}
  ...
  createMessage() {
    this.msg.create(this.message.type, this.message.content, {
  ...
  createNotify() {
    this.ntf.create(this.notify.type, this.notify.title, this.notify.content, {
